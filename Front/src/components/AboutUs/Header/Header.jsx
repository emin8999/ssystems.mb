      ...
      <Container>
        <div className="flex flex-col gap-6 md:gap-[20px] max-w-full md:max-w-[640px] pt-8 md:pt-[36px] pb-16 md:pb-[166px]">
          ...
          <div className="flex flex-col text-center md:text-left">
            <p className="text-sm md:text-[16px] font-normal leading-relaxed md:leading-[24px]">
              Company code: {t("AboutUs.Header.companyCode")}
            </p>
            <p className="text-sm md:text-[16px] font-normal leading-relaxed md:leading-[24px]">
              VAT Number: {t("AboutUs.Header.vatNumber")}
            </p>
          </div>
        </div>
      </Container>
